...
CREATE TABLE IF NOT EXISTS `publicidad`(
  ...
  `ID_CATEGORIA` int(11) NOT NULL,
  `ID_USUARIO` int(11) NOT NULL,
  `TITULO_PUBLICIDAD` varchar(180),
  `TEXTO_PUBLICIDAD` text NOT NULL,
  `ESTADO_PUBLICIDAD` varchar(20) NOT NULL,
  `CREACION_PUBLICIDAD` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY(`ID_PUBLICIDAD`),
  KEY `FK_ID_CATEGORIA_P` (`ID_CATEGORIA`),
  KEY `FK_ID_USUARIO_P` (`ID_USUARIO`)
  )ENGINE = InnoDB;
...
ADD CONSTRAINT `FK_ID_CATEGORIA_P` FOREIGN KEY (`ID_CATEGORIA`) REFERENCES `categoria` (`ID_CATEGORIA`),
ADD CONSTRAINT `FK_ID_USUARIO_P` FOREIGN KEY (`ID_USUARIO`) REFERENCES `usuario` (`ID_USUARIO`);
